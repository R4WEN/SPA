...
// grabs data and calls function so it turns up in body as a child of a div (so to be able to erase it w the other button)
...
// this should be first for easier readability, but i call a couple of funtions that have nothing to do w the assignment
// so i figured id rather end w it
